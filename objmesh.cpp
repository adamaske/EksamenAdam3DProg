...
#include "vertex.h"
#include "texture.h"
ObjMesh::ObjMesh(std::string fileName, Shader& shader, ObjectState state) : VisualObject(shader, state, nullptr)
{
    mTexture = nullptr;
    readFile(fileName);
    mMatrix.setToIdentity();
}
ObjMesh::ObjMesh(std::string fileName, Shader& shader, Texture* texture, ObjectState state) : VisualObject(shader, texture, state, nullptr)
{
    mTexture = texture;
